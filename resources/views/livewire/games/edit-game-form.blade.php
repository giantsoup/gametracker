...
mount(function ($game, $parentId = null) {
    ...
    $this->total_points = $game->total_points;
    $this->total_placements = count($game->pointsDistribution());
    $this->points_distribution = $game->pointsDistribution();
